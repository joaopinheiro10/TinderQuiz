...
public class ASCIIArtGenerator {
     ...
     * @throws Exception
     */
    private static String printTextArt(String artText, int textHeight, ASCIIArtFont fontType, String artSymbol) throws Exception {
     ...
     * @return
     */
    public static int findImageWidth(int textHeight, String artText, String fontName) {
     ...
     * @return
     */
    public static int getBaselinePosition(Graphics g, Font font) {
